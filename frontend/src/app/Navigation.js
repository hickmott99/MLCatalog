...
import { HOME_PATH, ADD_MODEL_PATH, VIEW_MODEL_PATH } from "../constants/constants";
  ...
  return (
    <div className="container-fluid d-flex justify-content-between align-items-center border-bottom">
      ...
      <ul className="nav">
        ...
        <li className="nav-item">
          <NavLink className={({ isActive }) => "nav-link bg-light border border-bottom-0" + (isActive ? " active bg-second-primary " : "")} to={VIEW_MODEL_PATH}>
